<nav class="bg-gray-500">
    <div class="flex justify-between items-center">
        <div class="flex justify-start items-center text-xl space-x-4">
            ...
            <!-- einde opdracht -->
            <a href="/afspraken"
                class="<?= isUri("afspraken") ? 'underline ' : '' ?>text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md font-medium">Afspraken</a>
            <a href="/klanten"
                    ...
                    <div
                        ...
                        <div class="flex items-center">
                            <?php if (user()->profielfoto): ?>
                                <img src="/<?= user()->profielfoto ?>" alt="profielfoto"
